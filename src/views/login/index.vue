        ...
        <el-form autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left"
            ...
            <el-form-item prop="username">
                ...
                <el-input name="username" type="text" v-model="loginForm.username" autoComplete="off"
                          :placeholder="userNamePlaceholder"></el-input>
            </el-form-item>
            ...
            <div>
            <el-radio-group @change="changeUserNamePlaceholder" v-model="loginForm.userType" style="margin-bottom: 25px;margin-top: 15px;width: 100%;text-align: center;">
              <el-radio label="tc" style="color: white;">教师</el-radio>
              <el-radio label="stu" style="color: white;margin-left: 50px;">学生</el-radio>
            </el-radio-group>
            </div>
...
<script>
    ...
    export default {
      ...
      methods: {
        ...
        changeUserNamePlaceholder(value) {
          if(value == 'stu'){
            this.userNamePlaceholder = '学号';
            this.usernameLength = 1;
          }else{
            this.userNamePlaceholder = '工号';
            this.usernameLength = 1;
          }          
        }
      },
